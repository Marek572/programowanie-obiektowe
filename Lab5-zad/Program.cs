...
namespace Lab5_zad
{
    ...
    class App
    {
        ...
        {
            Exercise1<string> team = new Exercise1<string>() { Manager = "Lukasz", MemberA = "Kuba", MemberB = "Tomek" };
    ...
    public class Exercise1<T> : IEnumerable<T>
    {
        ...
        class Excercise1Enumerator : IEnumerator<T>
        {
            private Exercise1<T> _team;
            private int _count = -1;

            public Excercise1Enumerator(Exercise1<T> team)
            {
                _team = team;
            }
    ...
    public class CurrencyRates<T, U> : IEnumerable where U : Enum
    {
        private T[] _rates;
        private int _lower;
        ...
        public CurrencyRates()
        {
            ...
            _rates = new T[1 + upper - _lower];
        }

        public T this[U key]
        {
            get { return _rates[Convert.ToInt32(key) - _lower]; }
            set { _rates[Convert.ToInt32(key) - _lower] = value; }
        }
